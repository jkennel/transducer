...
We can export 24 *.rsk files (each ~ 400 MB) containing one second data to hourly data in under 1 second.  Pressure and temperature will be output to separate files.
